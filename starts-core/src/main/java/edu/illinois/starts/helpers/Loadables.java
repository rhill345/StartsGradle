...
public class Loadables {
    ...
    public Loadables create(List<String> moreEdges, List<String> classPath,
    ...
    public void setSurefireClasspath(Classpath surefireClasspath) {
        this.classpathFiles = surefireClasspath.getClassPath();
    }

    public void setClasspath(List<String> classpathFiles) {
